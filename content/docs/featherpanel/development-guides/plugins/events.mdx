...
For a complete reference of all available FeatherPanel events with detailed examples, data structures, and controller references, see the **[Plugin Events Reference](./plugin-events-reference)** documentation.

The reference includes:

-   All authentication, user, server, ticket, and system events
-   Complete data structures for each event
-   Usage examples for common scenarios
-   Controller references for finding event implementations
