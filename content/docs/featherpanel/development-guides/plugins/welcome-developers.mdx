...
-   **[Plugin Events Reference](./plugin-events-reference)** - Complete reference for all available events
-   **[Plugin Development](./development)** - Creating plugins and file structure
-   **[Plugin Widgets](./plugins-widgets)** - Creating widgets to extend FeatherPanel pages
...
-   **Create custom pages** and **widgets** for enhanced UI
...
-   **Widget Plugins** - Embedded content in FeatherPanel pages
