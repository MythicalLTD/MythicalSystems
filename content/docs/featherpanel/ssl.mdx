...
<Tabs defaultValue="1">
  <TabsList>
    <TabsTrigger value="1">Certbot</TabsTrigger>
    <TabsTrigger value="apachecfapi">Apache w/CloudFlare API</TabsTrigger>
    <TabsTrigger value="caddycfapi">Caddy w/CloudFlare API</TabsTrigger>
  </TabsList>
  <TabsContent value="1">
        <Callout type="info">
        ...
        <Tabs defaultValue="t1cb">
          <TabsList>
            <TabsTrigger value="t1cb">NGINX</TabsTrigger>
            <TabsTrigger value="t1ap">Apache</TabsTrigger>
            <TabsTrigger value="t1cd">Caddy / Other</TabsTrigger>
          </TabsList>
          <TabsContent value="t1cb">
                ```sh
                sudo apt install -y python3-certbot-nginx
                ```
          </TabsContent>
          <TabsContent value="t1ap">
                ```sh
                sudo apt install -y python3-certbot-apache
                ```
          </TabsContent>
          <TabsContent value="t1cd">
                ```sh
        ...
        <Tabs defaultValue="t1ng">
          <TabsList>
            <TabsTrigger value="t1ng">NGINX</TabsTrigger>
            <TabsTrigger value="t1ap2">Apache</TabsTrigger>
            <TabsTrigger value="t1stalone">Standalone</TabsTrigger>
          </TabsList>
          <TabsContent value="t1ng">
                ```sh
                certbot certonly --nginx -d example.com
                ```
          </TabsContent>
          <TabsContent value="t1ap2">
                ```sh
                certbot certonly --apache -d example.com
                ```
          </TabsContent>
          <TabsContent value="t1stalone">
                ```sh
