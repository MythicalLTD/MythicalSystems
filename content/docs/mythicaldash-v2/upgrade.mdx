...
> [!CAUTION]
> **MythicalDash v2 is Deprecated - Do Not Upgrade**
> 
> Instead of upgrading this deprecated version, migrate to [MythicalDash V3 Remastered](/docs/mythicaldash-v3-remastered) for the latest features and security updates.
