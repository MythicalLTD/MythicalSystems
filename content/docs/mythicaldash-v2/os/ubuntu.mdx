...
> 
> This documentation is for a deprecated version. Please use [MythicalDash V3 Remastered](/docs/mythicaldash-v3-remastered) instead.
...
- [Next](/docs/mythicaldash-v2/install#installing-composer)