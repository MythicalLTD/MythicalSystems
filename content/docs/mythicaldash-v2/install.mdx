...
> 
> This version is no longer maintained. Please install [MythicalDash V3 Remastered](/docs/mythicaldash-v3-remastered) instead for the latest features and security updates.
...
| - | - | - | - |
| [Ubuntu](/docs/mythicaldash-v2/os/ubuntu) | 20.04 | ✅ | Documentation written assuming Ubuntu 20.04 as the base OS. |
| [Ubuntu](/docs/mythicaldash-v2/os/ubuntu)  | >=22.04 | ✅ | MariaDB can be installed without the repo setup script. |
| [Debian](/docs/mythicaldash-v2/os/debian) | 11 | ✅ | It can run, but we recommend using 12 for long-term usage! |
| [Debian](/docs/mythicaldash-v2/os/debian)  | >=12 | ✅ | The dash is developed on this os! |
